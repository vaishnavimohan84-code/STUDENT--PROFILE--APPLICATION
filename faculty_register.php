            ...
            <form action="model/faculty_register.php" method="post" >
              ...
              <div class="row gy-4">
				...
				<label>Department</label><br><br>
					...
					<option value="Bba">Computer Science</option>
					<option value="Bsc">Maths</option>
					<option value="Bca">Physics</option>
					<option value="Mcom">Chemistry</option>
					<option value="Mba">Tamil</option>
					<option value="Msc">English</option>
					<option value="Mca">B.B.A</option>
					</select>
				</div>
				
                <div class="col-6">
				<label>Email</label><br><br>
                  <input type="email" class="form-control" name="email" placeholder="Email" required pattern="^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.[cC][oO][mM]$" title="Please enter a valid email ending with .com">
                </div>

                <div class="col-6">
				<label>Mobile Number</label><br><br>
                  <input type="text" class="form-control" name="mobile" placeholder="Phone" required pattern="[0-9]{10}" title="Please enter a valid 10-digit mobile number">
                </div>
